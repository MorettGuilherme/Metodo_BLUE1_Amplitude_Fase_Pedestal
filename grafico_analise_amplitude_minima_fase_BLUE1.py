...
titulo_programa = colored("Plote do gráfico do dado estatístico da análise do erro de estimação da fase pelo método Best Linear Unbiased Estimator (BLUE1):\n", attrs=["bold"])
...
def principal_grafico_dado_estatistico_analise_fase_BLUE1():
    ...
    Matriz_Dados_Estatisticos_Analise_Fase_Ocupacao = leitura_dados_estatisticos_analise_fase_BLUE1(n_ocupacao, n_janelamento_ideal_amplitude_estimada, dado_estatistico, tipo_fase)
    grafico_dado_estatistico_analise_fase_BLUE1(n_ocupacao, opcao_dado_estatistico, Matriz_Dados_Estatisticos_Analise_Fase_Ocupacao)
