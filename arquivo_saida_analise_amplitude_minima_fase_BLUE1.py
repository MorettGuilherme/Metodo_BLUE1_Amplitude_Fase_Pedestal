...
titulo_programa = colored("Geração de arquivos de saída pela técnica de validação cruzada K-Fold para a análise do processo de estimação da fase pelo método Best Linear Unbiased Estimator (BLUE1):\n", attrs=["bold"])
...
def K_fold_BLUE1_analise_fase(parametro, n_ocupacao, n_janelamento_ideal_amplitude_estimada, Matriz_Pulsos_Sinais_Janelado, vetor_fase_referencia_janelado, valor_minimo_amplitude_estimada_processo_fase, tipo_fase, vetor_amplitude_referencia_janelado):
    ...
    for indice_teste in range(0, len(blocos_pulsos_sinais)):
        ...
        # A variável bloco_lista_erro_estimacao_fase recebe o valor de retorno da função metodo_BLUE1.
        bloco_lista_erro_estimacao_fase = metodo_BLUE1(parametro, n_janelamento_ideal_amplitude_estimada, bloco_treino_pulsos_sinais, bloco_teste_pulsos_sinais, bloco_teste_fase_referencia, valor_minimo_amplitude_estimada_processo_fase, bloco_treino_amplitude_referencia)
    ...
    arquivo_saida_dados_estatisticos_erro_estimacao_fase_BLUE1(n_ocupacao, n_janelamento_ideal_amplitude_estimada, media_var_blocos_erro_estimacao_fase, var_var_blocos_erro_estimacao_fase, DP_var_blocos_erro_estimacao_fase, media_tamanho_blocos_erro_estimacao_fase, valor_minimo_amplitude_estimada_processo_fase, tipo_fase, dado_estatistico = "var")
